...
<g:form controller="providerSignIn" params="[providerId:'twitter']">
    <button type="submit">
        <img alt="signin with twitter"
             src="${resource(dir: 'images/social/twitter', file: 'sign-in-with-twitter-d.png')}"/>
    </button>
</g:form>
...
<g:form controller="providerSignIn"  params="[providerId:'facebook']">
    <button type="submit">
        <img alt="signin with facebook"
             src="${resource(dir: 'images/social/facebook', file: 'sign-in-with-facebook.png')}"/>
    </button>
</g:form>
